...
/* Lighting */
#define NL_SUNLIGHT_INTENSITY   1.0  // 1.0 weak ~ 5.0 bright
...
#define NL_END_AMBIENT    vec3(1.0,1.0,1.0)

/* Sun/moon light color */
#define NL_DAWN_SUNLIGHT_COL   vec3(1.0,1.0,1.0)
#define NL_NOON_SUNLIGHT_COL   vec3(1.0,1.0,1.0)
#define NL_NIGHT_MOONLIGHT_COL vec3(1.0,1.0,1.0)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0,1.0,1.0)
#define NL_UNDERWATER_TORCH_COL vec3(1.0,1.0,1.0)
#define NL_NETHER_TORCH_COL     vec3(1.0,1.0,1.0)
...
#define NL_WAVE_RANGE 0.0     // 6.0 upto 6 blocks ~ 32.0 upto 32 blocks away (slower)
...
#define NL_WATER_TINT vec3(1.0,1.0,1.0)
...
#define NL_CLOUD1_DEPTH 0.0                // 0.0 no bump ~ 10.0 large bumps
#define NL_CLOUD1_SPEED 0.0               // 0.0 static ~ 0.4 fast moving
...
#define NL_CLOUD2_LAYER2_VELOCITY 0.0           // 0.0 static ~ 4.0 very fast
...
#define NL_SUN_PATH_YAW    0.0 //
#define NL_MOON_PATH_YAW   0.0 //
#define NL_SUN_PATH_TILT   0.0 //
#define NL_MOON_PATH_TILT  0.0 //
...
#define NL_LAVA_NOISE_SPEED 0.0  // 0.0 still ~ 0.8 fast
